...
### Summary
Backend API package configuration file. Defines all npm packages, scripts, and project metadata for the Toki backend server.

### Fixes Applied log
- problem: Version bump needed for new release.
- solution: Bumped version from 1.0.7 to 1.0.9 to match frontend version.
- problem: Version bump needed for new release.
- solution: Bumped version from 1.0.9 to 1.0.10 to match frontend version.
- problem: Version bump needed for new release.
...
- problem: Version bump needed for new release.
- solution: Bumped version from 1.0.17 to 1.0.18 to match frontend version.
- problem: Version bump needed for new release.
- solution: Bumped version from 1.0.18 to 1.0.19 to match frontend version.
...
- Updated version field in package.json from "1.0.17" to "1.0.18" to keep backend and frontend versions synchronized.
- Updated version field in package.json from "1.0.18" to "1.0.19" to keep backend and frontend versions synchronized.
